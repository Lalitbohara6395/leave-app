...
export default function TodoPage() { // Our main functional component for the page
  ...
  return ( // UI Layout
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-12 px-4"> {/* Page wrapper */}
      ...
      <Link href="/abouts" className="mt-10 text-slate-400 font-medium hover:text-blue-500 transition-colors">
        About this project →
      </Link>
      <Link href="/company" className="mt-5 text-slate-400 font-medium hover:text-blue-500 transition-colors">
        About This Policy →
      </Link>
      <Link href="/contact" className="mt-5 text-slate-400 font-medium hover:text-blue-500 transition-colors">
        For Contact Us →
      </Link>
      <Link href="/usersMassages" className="mt-5 text-slate-400 font-medium hover:text-blue-500 transition-colors">
        Users Queries →
      </Link>
    </div>
  );
