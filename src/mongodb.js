...
async function runTutorial() {
    try {
        ...
        // find todos based on priority
        const multiple = await Todo.find({ priority: 'high', isCompleted: true })
        console.log("Found priority based Todo:", multiple);
        ...
        // delete all todos whos iscompleted true with the help of deleteMany
        ...
        await Todo.create([
            { task: "Finish Lesson 1", isCompleted: true, priority: 'low' },
            { task: "Start Lesson 2", isCompleted: false, priority: 'high' },
            { task: "Start Lesson 3", isCompleted: false, priority: 'medium' },
            { task: "Start Lesson 4", isCompleted: true, priority: 'low' },
        ]);
        ...
        console.log('finding todos with the help of or operator', result)
        ...
        console.log('finding todos with the help of and operator', result2)
